...
// 5. 聚合查询 - 基于你的新API
export async function queryAggregate(symbol, days = 5, aggFunc = 'MAX', column = '最高') {
  return getFrom(`${baseURL}/api/aggregate?code=${symbol}&days=${days}&agg_func=${aggFunc}&agg_col=${column}`);
}
